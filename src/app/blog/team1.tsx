...
export default function OurTeam(){
    ...
    return(
        <div className="w-full mt-20 mb-20">
            ...
            <div className="flex h-[1700px] w-[1050px] flex-wrap justify-center items-center gap-10 ml-80">
                {teamImages.map((image, index)=>
                (<div key={index}>
                    <Image src={image} alt={`team image ${index+1}`} height={231} width={316} layout="responsive" />
