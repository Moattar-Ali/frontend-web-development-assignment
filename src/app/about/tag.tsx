...
export default function HeroTag (){
    return(
        <div className="flex mx-auto mt-40 justify-center items-center">
            <div className="h-[615px] w-[850px] bg-blue-500 text-white items-center p-40">
            ...
            <div className="grid h-[615px] w-[850px]">
                <Image src="/unsplash_vjMgqUkS8q8.png" alt="image" height={615} width={590} layout="responsive"/>
            </div>
        </div>
    )
}