...
export default function ProductCard(){
    ...
    return(
        <div className="h-[1778px] w-[1124px] flex gap-6 flex-wrap m-5 mx-80 justify-center items-center">
         {cards.map((image, index)=>(
            <div key={index}>
        <Image src={image} alt={`card ${index+1}`} layout="responsive" height={300} width={239} />
        <div className="gap-5">
